<template>
  <div id="app" :class="{ hide: hide }">
    <navbar @logout="closePage" v-if="$root.authenticated || hide" :items="navbar" @toggle="toggler"
      class="d-none d-md-block" />
    <mobile-navbar @logout="closePage" v-if="$root.authenticated || hide" :items="navbar" class="d-block d-md-none" />
    <div class="page-body" :class="{
      'navbar-is-open': navbarIsOpen && $root.authenticated,
      'navbar-is-closed': !navbarIsOpen && $root.authenticated,
    }">
